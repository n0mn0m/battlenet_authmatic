...
class Blizzard(OAuth2):
    ...
    user_authorization_url = 'https://us.battle.net/oauth/authorize'
    access_token_url = 'https://us.battle.net/oauth/token'
    user_info_url = 'https://us.api.battle.net/account/user'
    ...
    @staticmethod
    def _x_user_parser(user, data):
        user.username = data.get('battletag')
        return user
...
PROVIDER_ID_MAP = [OAuth2, Behance, Bitly, Cosm, DeviantART, Facebook, Foursquare, GitHub, Google, LinkedIn,
          PayPal, Reddit, Viadeo, VK, WindowsLive, Yammer, Yandex, Eventbrite, Amazon, Blizzard]
